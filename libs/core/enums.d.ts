...
declare namespace input {
    ...
    declare enum ConcurrencyModel {
    MESSAGE_BUS_LISTENER_REENTRANT = 0x0008,  // MESSAGE_BUS_LISTENER_REENTRANT
    MESSAGE_BUS_LISTENER_QUEUE_IF_BUSY = 0x0010,  // MESSAGE_BUS_LISTENER_QUEUE_IF_BUSY
    MESSAGE_BUS_LISTENER_DROP_IF_BUSY = 0x0020,  // MESSAGE_BUS_LISTENER_DROP_IF_BUSY
    MESSAGE_BUS_LISTENER_IMMEDIATE = 0x00C0,
    }
